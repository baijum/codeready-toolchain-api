...
* Go version 1.19 - download for your development environment https://golang.org/dl/[here].
* Operator SDK 1.25 - download for your development environment https://v1-25-x.sdk.operatorframework.io/docs/installation/#install-from-github-release[here]
